package Lab2_Shabanevych;
import java.util.Scanner;

public class Main {
	public static boolean edAtTheEnd(String input) {
	...
	public static void wordsWithSpaces(String input) {
	...
	public static void main(String[] args) {
		...
		System.out.println(edAtTheEnd(firstTask));
